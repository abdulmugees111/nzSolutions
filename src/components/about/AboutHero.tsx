  ...
  return (
    <div className="flex items-center justify-center">
      <svg
        ...
        className="w-full max-w-[280px] sm:max-w-[360px] lg:max-w-[400px]"
        aria-hidden="true"
      >
        <defs>
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#e8f0fe] via-[#f0f6ff] to-[#dbeafe] py-10 sm:py-14 lg:py-16">
      <svg className="pointer-events-none absolute inset-0 h-full w-full opacity-[0.06]" aria-hidden="true">
        <defs>
          <pattern id="about-net" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
        ...
        <rect width="100%" height="100%" fill="url(#about-net)" />
      </svg>
      ...
      <Container className="grid items-center gap-8 lg:gap-12 lg:grid-cols-[1.05fr_0.95fr]">
        <div>
          <SectionHeader
            ...
            title="About Us"
            description="Delivering end-to-end fixed-line telecom and digital solutions across the UK, from FTTP survey, design and installation to digital data management, network records, testing and operational handover."
          />
        </div>
